...
export function LanguagesOverview() {
  return (
    <MarketingLayout>
      <Seo
        title="AI Voice Agents in 10 Indian Languages — Vistrow Voice"
        description="Artha answers calls in Hindi, Marathi, Tamil, Telugu, Kannada, Bengali, Gujarati, Malayalam, Punjabi, and Odia — switching mid-call to match whichever language the caller uses."
        path="/languages"
      />
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 text-center md:px-8 lg:py-20">
        ...
        <p className="mx-auto mt-5 max-w-xl text-lg text-text-muted">
          Artha speaks ten Indian languages and English, and switches mid-call when the caller does —
          including the everyday mixed speech most people actually use on the phone.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-8 md:px-8">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {LANGUAGES.map((lang) => (
            ...
            >
              <p className="font-display text-3xl font-bold leading-none text-primary">{lang.native}</p>

...
_INDUSTRY_MANNER: dict[str, str] = {
    ...
    "healthcare": (
        ...
        "suits, take their name and phone number so the clinic can call back. A caller who "
        "rang to book must never be left with nothing — either a time, or a callback on "
        "record. Only close once they say they are done.\n"
